...
# ==============================================================================
# Build native-app.tar.gz for upload to narzaut/rattin-public releases
...
echo "Done: $OUT ($SIZE)"
echo ""
echo "Upload to: https://github.com/narzaut/rattin-public/releases"
echo "  gh release create v1.0.0-native --repo narzaut/rattin-public native-app.tar.gz"
